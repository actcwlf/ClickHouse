...
namespace JoinStuff
{
    ...
    template <>
    void JoinUsedFlags::setUsed<true>(size_t i [[maybe_unused]])
    {
    ...
    template <>
    bool JoinUsedFlags::getUsed<true>(size_t i [[maybe_unused]])
    {
        return flags[i].load();
    }

    template <>
    bool JoinUsedFlags::setUsedOnce<true>(size_t i [[maybe_unused]])
    {
